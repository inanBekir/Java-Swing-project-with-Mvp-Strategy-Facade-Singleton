...
public class Fonksiyonlar {
 ...
 public void GözetmenKaydet(String GozetmenText){
        String path = "Content\\Facade\\Gozetmenler.txt";
         try{
 ...
 public void OgretimUyesiKaydet(String OgrText){
        String path2 = "Content\\Facade\\OgretimUyeleri.txt";
         try{
                  ...
                  yaz2.close();
                  System.out.println("Gözetmen ve Ogretim Uyesi Kaydetme İşlemi Başarılı");
 ...
 public void DerslikKaydet(String binaText,int salonText,String kodText,int kapasiteText){
